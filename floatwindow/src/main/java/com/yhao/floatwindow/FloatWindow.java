...
public class FloatWindow {
    ...
    private Map<String, IFloatWindow> mFloatWindowMap;
    ...
    static FloatWindow getInstance() {
    ...
    public static IFloatWindow get(@NonNull String tag) {
        FloatWindow instance = FloatWindow.getInstance();
        return instance.mFloatWindowMap == null ? null : instance.mFloatWindowMap.get(tag);
    }
    ...
    public static void destroy(String tag) {
        FloatWindow instance = FloatWindow.getInstance();
        if (FloatWindow.getInstance().mFloatWindowMap == null || !instance.mFloatWindowMap.containsKey(tag)) {
            return;
        }
        instance.mFloatWindowMap.get(tag).dismiss();
        instance.mFloatWindowMap.remove(tag);
    }
    ...
    public static class B {
        ...
        public void build() {
            FloatWindow instance = FloatWindow.getInstance();
            if (instance.mFloatWindowMap == null) {
            ...
            instance.mFloatWindowMap.put(mTag, floatWindowImpl);
        }
    }
}